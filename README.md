...
We have a CI workflow specified which will run on every push and pull-request. Our `main` branch is protected from merges where the CI workflow does not pass.
